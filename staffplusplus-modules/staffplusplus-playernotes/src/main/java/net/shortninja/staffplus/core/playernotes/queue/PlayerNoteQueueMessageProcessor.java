...
public class PlayerNoteQueueMessageProcessor extends QueueMessageProcessor {
    private static final String PROCESSING_GROUP = "player-note/";

    public PlayerNoteQueueMessageProcessor(QueueRepository queueRepository,
    ...
    protected ServerSyncConfig getServerSyncConfig() {
        return serverSyncConfiguration.notesSyncServers;
    }
