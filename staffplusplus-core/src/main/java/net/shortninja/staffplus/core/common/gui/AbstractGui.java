...
public abstract class AbstractGui implements IGui {
    protected final Messages messages = TubingBukkitPlugin.getPlugin().getIocContainer().get(Messages.class);
    protected final OnlineSessionsManager sessionManager = TubingBukkitPlugin.getPlugin().getIocContainer().get(OnlineSessionsManager.class);
    protected final Options options = TubingBukkitPlugin.getPlugin().getIocContainer().get(Options.class);
