package net.shortninja.staffplus.core.punishments.mute.gui.cmd;
...
public class ExtendMuteCmd extends AbstractCmd {
    ...
    public ExtendMuteCmd(PermissionHandler permissionHandler,
                         Messages messages,
    ...
    protected boolean executeCmd(CommandSender sender, String alias, String[] args, SppPlayer player, Map<String, String> optionalParameters) {
        ...
        muteService.extendMute(sender, player, TimeUnit.getDuration(timeUnit, amount));
        return true;
    }
