...
public class InfractionsCmd extends AbstractCmd {
    ...
    public InfractionsCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options) {
        super(options.infractionsConfiguration.getCommandOpenGui(), permissionHandler, authenticationService, messages, message, playerManager, options);
