...
@GuiController
public class ExamineInventoryGuiController {
    ...
    public ExamineInventoryGuiController(PlayerManager playerManager,
    ...
    public GuiActionReturnType openInventory(Player staff,
        ...
        if (target.isOnline()) {
            chestGUI = new ChestGUI(target,
                ...
                permissionHandler.has(staff, permissionExamineInventoryInteraction));
        } else {
            chestGUI = new ChestGUI(target,
                ...
                45,
                ChestGuiType.PLAYER_INVENTORY_EXAMINE,
                permissionHandler.has(staff, permissionExamineInventoryInteractionOffline));
        }
