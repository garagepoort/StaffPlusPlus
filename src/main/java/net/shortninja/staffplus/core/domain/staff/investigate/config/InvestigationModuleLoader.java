...
public class InvestigationModuleLoader extends AbstractConfigLoader<InvestigationConfiguration> {
    ...
    protected InvestigationConfiguration load() {
        ...
        String investigatePermission = permissionsConfig.getString("investigations.manage.investigate");
        String viewPermission = permissionsConfig.getString("investigations.manage.view");
        String linkEvidencePermission = permissionsConfig.getString("investigations.manage.link-evidence");
        String addNotePermission = permissionsConfig.getString("investigations.manage.add-note");
        String deleteNotePermission = permissionsConfig.getString("investigations.manage.delete-note");
        String deleteNoteOthersPermission = permissionsConfig.getString("investigations.manage.delete-note-others");
        String startInvestigationCmd = commandsConfig.getString("investigations.manage.start");
        String pauseInvestigationCmd = commandsConfig.getString("investigations.manage.pause");
        String concludeInvestigationCmd = commandsConfig.getString("investigations.manage.conclude");
