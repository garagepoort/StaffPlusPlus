...
import net.shortninja.staffplus.domain.staff.freeze.FreezeRequest;
import net.shortninja.staffplus.domain.staff.mode.handler.CpsHandler;
import net.shortninja.staffplus.domain.staff.mode.handler.CustomModuleExecutor;
...
import static net.shortninja.staffplus.domain.staff.mode.item.CustomModuleConfiguration.ModuleType.COMMAND_DYNAMIC;
