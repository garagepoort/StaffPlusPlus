package net.shortninja.staffplus.server.compatibility.v1_7_R1;
...
public class Protocol_v1_7_R1 extends AbstractProtocol implements IProtocol {
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", player.getUniqueId().toString(), (ChannelHandler) new PacketHandler_v1_7_R1(player));
    }
