...
public class ManageAppealedWarningsGuiCmd extends AbstractCmd {
    ...
    public ManageAppealedWarningsGuiCmd(Messages messages, CommandService commandService, PermissionHandler permissionHandler, GuiActionService guiActionService) {
    ...
    protected boolean executeCmd(CommandSender sender, String alias, String[] args, SppPlayer player, Map<String, String> optionalParameters) {
        ...
        guiActionService.executeAction((Player) sender, "manage-warnings/view/appealed-warnings");
        return true;
    }
