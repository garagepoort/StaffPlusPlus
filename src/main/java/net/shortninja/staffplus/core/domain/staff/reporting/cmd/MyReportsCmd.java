...
public class MyReportsCmd extends AbstractCmd {
    ...
    public MyReportsCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options) {
        super(options.reportConfiguration.getMyReportsCmd(), permissionHandler, authenticationService, messages, message, playerManager, options);
