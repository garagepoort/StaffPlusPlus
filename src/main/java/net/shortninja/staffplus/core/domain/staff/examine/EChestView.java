...
public class EChestView extends AbstractCmd {
    ...
    public EChestView(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options, EnderChestService enderChestService) {
        super(options.enderchestsConfiguration.getCommandOpenEnderChests(), permissionHandler, authenticationService, messages, message, playerManager, options);
