package net.shortninja.staffplus.core.punishments.mute.gui;
...
import net.shortninja.staffplus.core.infractions.config.InfractionsConfiguration;
import net.shortninja.staffplus.core.infractions.gui.views.InfractionGuiProvider;
...
public class MutedPlayerItemBuilder implements InfractionGuiProvider<Mute> {
    ...
    public ItemStack build(Mute mute) {
        ...
        List<String> lore = LoreBuilder.builder("&b", "&6")
            ...
            .addItem("Server", mute.getServerName(), options.serverSyncConfiguration.muteSyncServers.isEnabled())
