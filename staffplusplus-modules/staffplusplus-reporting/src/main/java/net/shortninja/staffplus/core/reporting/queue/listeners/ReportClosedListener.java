package net.shortninja.staffplus.core.reporting.queue.listeners;

import be.garagepoort.mcioc.IocBean;
import be.garagepoort.mcioc.IocMultiProvider;
import net.shortninja.staffplus.core.application.queue.QueueMessageListener;
import net.shortninja.staffplus.core.reporting.ManageReportService;
import net.shortninja.staffplus.core.reporting.queue.dto.ReportClosedQueueMessage;
