...
public class InvestigationPausedBungeeReceiver implements PluginMessageListener {
    ...
    public InvestigationPausedBungeeReceiver(BungeeClient bungeeClient, SessionManagerImpl sessionManager, PlayerManager playerManager) {
    ...
    public void onPluginMessageReceived(String channel, Player player, byte[] message) {
        ...
        bungeeMessage.ifPresent(b -> {
            ...
            Bukkit.getPluginManager().callEvent(new InvestigationPausedBungeeEvent(b));
        });
    }
}
