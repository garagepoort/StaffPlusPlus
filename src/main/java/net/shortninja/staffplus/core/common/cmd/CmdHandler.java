...
import net.shortninja.staffplus.core.domain.confirmation.ConfirmActionCmd;
import net.shortninja.staffplus.core.domain.staff.PersonnelCmd;
import net.shortninja.staffplus.core.domain.staff.alerts.AlertsCmd;
import net.shortninja.staffplus.core.domain.staff.altaccountdetect.cmd.AltDetectWhitelistCmd;
import net.shortninja.staffplus.core.domain.staff.ban.cmd.BanCmd;
import net.shortninja.staffplus.core.domain.staff.ban.cmd.TempBanCmd;
import net.shortninja.staffplus.core.domain.staff.ban.cmd.UnbanCmd;
import net.shortninja.staffplus.core.domain.staff.broadcast.cmd.BroadcastCmd;
import net.shortninja.staffplus.core.domain.staff.examine.ClearInvCmd;
import net.shortninja.staffplus.core.domain.staff.examine.EChestView;
import net.shortninja.staffplus.core.domain.staff.examine.ExamineCmd;
import net.shortninja.staffplus.core.domain.staff.freeze.FreezeCmd;
import net.shortninja.staffplus.core.domain.staff.infractions.cmd.InfractionsCmd;
import net.shortninja.staffplus.core.domain.staff.infractions.cmd.InfractionsTopCmd;
import net.shortninja.staffplus.core.domain.staff.kick.cmd.KickCmd;
import net.shortninja.staffplus.core.domain.staff.mode.cmd.*;
import net.shortninja.staffplus.core.domain.staff.mute.cmd.MuteCmd;
import net.shortninja.staffplus.core.domain.staff.mute.cmd.TempMuteCmd;
import net.shortninja.staffplus.core.domain.staff.mute.cmd.UnmuteCmd;
import net.shortninja.staffplus.core.domain.staff.protect.cmd.ProtectAreaCmd;
import net.shortninja.staffplus.core.domain.staff.protect.cmd.ProtectPlayerCmd;
import net.shortninja.staffplus.core.domain.staff.reporting.cmd.*;
import net.shortninja.staffplus.core.domain.staff.revive.ReviveCmd;
import net.shortninja.staffplus.core.domain.staff.staffchat.cmd.StaffChatCmd;
import net.shortninja.staffplus.core.domain.staff.teleport.cmd.TeleportBackCmd;
import net.shortninja.staffplus.core.domain.staff.teleport.cmd.TeleportHereCmd;
import net.shortninja.staffplus.core.domain.staff.teleport.cmd.TeleportToLocationCmd;
import net.shortninja.staffplus.core.domain.staff.teleport.cmd.TeleportToPlayerCmd;
import net.shortninja.staffplus.core.domain.staff.tracing.TraceCmd;
import net.shortninja.staffplus.core.domain.staff.vanish.VanishCmd;
import net.shortninja.staffplus.core.domain.staff.warn.warnings.cmd.*;
