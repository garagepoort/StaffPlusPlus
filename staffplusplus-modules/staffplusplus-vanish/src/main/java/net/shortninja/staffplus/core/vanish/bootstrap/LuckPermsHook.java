package net.shortninja.staffplus.core.vanish.bootstrap;
...
import net.shortninja.staffplus.core.vanish.VanishLuckPermsContextCalculator;
...
public class LuckPermsHook implements PluginDisable, BeforeTubingReload {
    ...
    public LuckPermsHook(OnlineSessionsManager sessionManager, TubingBukkitPlugin tubingPlugin) {
        ...
        if (luckPermsEnabled) {
            tubingPlugin.getLogger().info("Luckperms enabled");
