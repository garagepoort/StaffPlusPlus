...
public class StaffModeItemsService {
    ...
    private static final Logger logger = TubingBukkitPlugin.getPlugin().getLogger();
    ...
    public StaffModeItemsService(StaffModeOptions options, PlayerSettingsRepository playerSettingsRepository,
