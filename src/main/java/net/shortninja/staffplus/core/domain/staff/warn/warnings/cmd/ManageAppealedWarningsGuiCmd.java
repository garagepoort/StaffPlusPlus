...
public class ManageAppealedWarningsGuiCmd extends AbstractCmd {
    ...
    public ManageAppealedWarningsGuiCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options) {
        super(options.manageWarningsConfiguration.getCommandManageAppealedWarningsGui(), permissionHandler, authenticationService, messages, message, playerManager, options);
