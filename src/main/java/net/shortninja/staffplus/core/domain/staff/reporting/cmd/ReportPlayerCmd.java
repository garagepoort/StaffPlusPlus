...
public class ReportPlayerCmd extends AbstractCmd {
    ...
    public ReportPlayerCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options, ReportService reportService) {
        super(options.commandReportPlayer, permissionHandler, authenticationService, messages, message, playerManager, options);
