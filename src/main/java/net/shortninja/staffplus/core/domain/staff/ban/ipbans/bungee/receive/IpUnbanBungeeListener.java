...
public class IpUnbanBungeeListener implements PluginMessageListener {
    ...
    public IpUnbanBungeeListener(BungeeClient bungeeClient, Options options) {
    ...
    public void onPluginMessageReceived(String channel, Player player, byte[] message) {
        if(options.serverSyncConfiguration.banSyncEnabled) {
            ...
            banBungeeDto.ifPresent(b -> Bukkit.getPluginManager().callEvent(new IpUnbanBungeeEvent(b)));
        }
    }
}
