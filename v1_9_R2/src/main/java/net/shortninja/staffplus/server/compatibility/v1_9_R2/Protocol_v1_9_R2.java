package net.shortninja.staffplus.server.compatibility.v1_9_R2;
...
public class Protocol_v1_9_R2 extends AbstractProtocol implements IProtocol {
    public Protocol_v1_9_R2(IStaffPlus staffPlus) {
        super(staffPlus);
    }
