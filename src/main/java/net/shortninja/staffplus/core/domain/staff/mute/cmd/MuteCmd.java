...
public class MuteCmd extends AbstractCmd {
    ...
    public MuteCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options, MuteService muteService, SessionManagerImpl sessionManager) {
        super(options.muteConfiguration.getCommandMutePlayer(), permissionHandler, authenticationService, messages, message, playerManager, options);
