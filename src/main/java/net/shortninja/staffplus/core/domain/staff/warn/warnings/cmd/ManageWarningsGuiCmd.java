...
public class ManageWarningsGuiCmd extends AbstractCmd {
    ...
    public ManageWarningsGuiCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options) {
        super(options.manageWarningsConfiguration.getCommandManageWarningsGui(), permissionHandler, authenticationService, messages, message, playerManager, options);
