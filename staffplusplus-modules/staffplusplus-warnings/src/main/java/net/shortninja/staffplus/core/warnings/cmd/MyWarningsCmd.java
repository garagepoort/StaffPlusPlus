package net.shortninja.staffplus.core.warnings.cmd;
...
public class MyWarningsCmd extends AbstractCmd {
    ...
    protected boolean executeCmd(CommandSender sender, String alias, String[] args, SppPlayer player, Map<String, String> optionalParameters) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(TubingBukkitPlugin.getPlugin(), ()-> warnService.markWarningsRead(((Player) sender).getUniqueId()));
        return true;
    }
