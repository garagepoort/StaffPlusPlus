...
import net.shortninja.staffplus.staff.infractions.cmd.InfractionsCmd;
import net.shortninja.staffplus.staff.kick.cmd.KickCmd;
...
public class CmdHandler {
    ...
    private BaseCmd[] loadCommands() {
        return new BaseCmd[]{
            ...
            new BaseCmd(new ExamineCmd(options.commandExamine), true, options.permissionExamine, "Examines the player's inventory", "{player}"),
            new BaseCmd(new NotesCmd(options.commandNotes), true, options.permissionExamine, "Adds or manages a player's notes", "[player] [note]"),
            ...
            new BaseCmd(new VanishCmd(options.commandVanish), options.vanishEnabled, Arrays.asList(options.permissionVanishTotal, options.permissionVanishList), "Enables or disables the type of vanish for the player.", "[total | list] {player} {enable | disable}"),
