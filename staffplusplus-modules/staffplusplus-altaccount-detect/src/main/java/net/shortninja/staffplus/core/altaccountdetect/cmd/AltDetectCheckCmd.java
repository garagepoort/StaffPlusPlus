package net.shortninja.staffplus.core.altaccountdetect.cmd;
...
import net.shortninja.staffplus.core.altaccountdetect.AltDetectResult;
import net.shortninja.staffplus.core.altaccountdetect.AltDetectionService;
