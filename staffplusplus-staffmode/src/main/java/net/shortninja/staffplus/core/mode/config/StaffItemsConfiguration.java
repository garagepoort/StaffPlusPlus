...
import net.shortninja.staffplus.core.mode.config.modeitems.compass.CompassModeConfiguration;
import net.shortninja.staffplus.core.mode.config.modeitems.counter.CounterModeConfiguration;
...
import net.shortninja.staffplus.core.mode.config.modeitems.follow.FollowModeConfiguration;
import net.shortninja.staffplus.core.mode.config.modeitems.freeze.FreezeModeStaffModuleConfiguration;
import net.shortninja.staffplus.core.mode.config.modeitems.gui.GuiModeConfiguration;
import net.shortninja.staffplus.core.mode.config.modeitems.playerdetails.PlayerDetailsModeConfiguration;
import net.shortninja.staffplus.core.mode.config.modeitems.randomteleport.RandomTeleportModeConfiguration;
