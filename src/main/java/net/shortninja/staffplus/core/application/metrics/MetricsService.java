...
public class MetricsService {
    ...
    public MetricsService(Options options, BanConfiguration banConfiguration, AltDetectConfiguration altDetectConfiguration, MuteConfiguration muteConfiguration) {
