...
public class SqliteMuteRepository extends AbstractSqlMuteRepository {
    ...
    public SqliteMuteRepository(PlayerManager playerManager) {
        super(playerManager);
    }
    ...
    public int addMute(Mute mute) {
        try (Connection connection = getConnection();
             PreparedStatement insert = connection.prepareStatement("INSERT INTO sp_muted_players(reason, player_uuid, issuer_uuid, end_timestamp, creation_timestamp) " +
                 "VALUES(?, ?, ?, ?, ?);")) {
