package net.shortninja.staffplus.core.mode.custommodules;
...
import net.shortninja.staffplus.core.mode.custommodules.preprocessors.CustomModulePreProcessor;
import net.shortninja.staffplus.core.mode.custommodules.state.CustomModuleStateMachine;
...
import static net.shortninja.staffplus.core.mode.custommodules.CustomModuleConfiguration.ModuleType.COMMAND_DYNAMIC;
