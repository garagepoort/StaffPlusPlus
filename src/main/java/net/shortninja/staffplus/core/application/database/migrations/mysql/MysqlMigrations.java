...
import net.shortninja.staffplus.core.application.database.migrations.common.*;
...
public class MysqlMigrations implements SqlMigrations {
    ...
    private static final List<Migration> migrations = Arrays.asList(
        ...
        new V29_AlterBansTableAddServerColumnMigration(),
        new V30_AlterDelayedActionsTableAddServerColumnMigration(),
        new V31_AlterKickedPlayersTableAddServerColumnMigration(),
    ...
    public MysqlMigrations(SqlConnectionProvider sqlConnectionProvider) {
        datasource = sqlConnectionProvider.getDatasource();
    }
