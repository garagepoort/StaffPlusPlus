...
public class TempBanCmd extends AbstractCmd {
    ...
    public TempBanCmd(PermissionHandler permissionHandler, AuthenticationService authenticationService, Messages messages, MessageCoordinator message, PlayerManager playerManager, Options options, BanService banService) {
        super(options.banConfiguration.getCommandTempBanPlayer(), permissionHandler, authenticationService, messages, message, playerManager, options);
