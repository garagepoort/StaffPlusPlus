package net.shortninja.staffplus.core.domain.staff.ban.appeals.queue;
...
public class BanAppealQueueMessageProcessor extends QueueMessageProcessor {
    private static final String PROCESSING_GROUP = "ban/";

    public BanAppealQueueMessageProcessor(QueueRepository queueRepository,
    ...
    protected ServerSyncConfig getServerSyncConfig() {
        return serverSyncConfiguration.banSyncServers;
    }
