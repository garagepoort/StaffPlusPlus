...
public class CmdHandler {
    ...
    public CmdHandler(IProtocol versionProtocol, Options options, @IocMulti(SppCommand.class) List<SppCommand> sppCommands) {
    ...
    private void registerCommands() {
        ...
        sppCommands.stream()
            .map(sppCommand -> new BaseCmd((Command) sppCommand))
