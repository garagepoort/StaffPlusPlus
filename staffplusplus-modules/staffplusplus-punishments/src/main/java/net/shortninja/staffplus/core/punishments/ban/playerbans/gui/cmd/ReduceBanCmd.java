package net.shortninja.staffplus.core.punishments.ban.playerbans.gui.cmd;
...
public class ReduceBanCmd extends AbstractCmd {
    ...
    public ReduceBanCmd(PermissionHandler permissionHandler,
                        Messages messages,
    ...
    protected boolean executeCmd(CommandSender sender, String alias, String[] args, SppPlayer player, Map<String, String> optionalParameters) {
        ...
        banService.reduceBan(sender, player, TimeUnit.getDuration(timeUnit, amount));
        return true;
    }
