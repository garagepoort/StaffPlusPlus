...
import net.shortninja.staffplus.common.config.migrators.ConfigMigrator;
import net.shortninja.staffplus.common.config.migrators.StaffModeCommandMigrator;
