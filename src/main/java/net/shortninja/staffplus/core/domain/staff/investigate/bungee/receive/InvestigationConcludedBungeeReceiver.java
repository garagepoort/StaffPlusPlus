...
public class InvestigationConcludedBungeeReceiver implements PluginMessageListener {
    ...
    public InvestigationConcludedBungeeReceiver(BungeeClient bungeeClient) {
    ...
    public void onPluginMessageReceived(String channel, Player player, byte[] message) {
        ...
        bungeeMessage.ifPresent(b -> Bukkit.getPluginManager().callEvent(new InvestigationConcludedBungeeEvent(b)));
    }
}
