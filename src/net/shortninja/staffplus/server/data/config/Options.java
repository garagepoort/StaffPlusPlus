...
public class Options
{
	...
	public ModuleType stringToModuleType(String string)
	{
		ModuleType moduleType = ModuleType.ITEM;
		boolean isValid = JavaUtils.isValidEnum(ModuleType.class, string);
		
		if(!isValid)
		{
			message.sendConsoleMessage("Invalid module type '" + string + "'!", true);
		}else moduleType = ModuleType.valueOf(string);
