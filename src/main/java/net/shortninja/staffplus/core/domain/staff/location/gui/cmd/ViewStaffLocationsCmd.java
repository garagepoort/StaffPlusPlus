...
public class ViewStaffLocationsCmd extends AbstractCmd {
    ...
    public ViewStaffLocationsCmd(Messages messages, PermissionHandler permissionHandler, CommandService commandService, GuiActionService guiActionService) {
    ...
    protected boolean executeCmd(CommandSender sender, String alias, String[] args, SppPlayer player, Map<String, String> optionalParameters) {
        ...
        guiActionService.executeAction((Player) sender, "staff-locations/view");
        return true;
    }
