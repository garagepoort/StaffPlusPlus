...
public class CmdHandler implements PluginDisable, BeforeTubingReload {
    ...
    public CmdHandler(@InjectTubingPlugin TubingBukkitPlugin tubingPlugin, IProtocolService protocolService, ConfigurationLoader configurationLoader, @IocMulti(SppCommand.class) List<SppCommand> sppCommands, Messages messages) {
    ...
    private void registerCommands() {
        commands = sppCommands.stream()
            ...
            .map(sppCommand -> new BaseCmd(tubingPlugin, messages, (org.bukkit.command.Command) sppCommand))
